...
// For newer ESP32 Arduino core, use esp_rom_gpio_pad_select_gpio
#define gpio_pad_select_gpio(x) esp_rom_gpio_pad_select_gpio(x)
#define ets_delay_us(x) esp_rom_delay_us(x)
